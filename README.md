...
<body>
    ...
    <div class="footer">
        Copyright © 2020 Silicon Private Limited, Developed by SHERWIN ROGER.
    </div>
    </div>
</body>
...
## RESULT:
Thus a website is designed for the chip manufacturing company and is hosted in the URL http://praveen.student.saveetha.in:8000/. HTML code is validated.